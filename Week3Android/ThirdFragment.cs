...
namespace Week3Android
{
    public class ThirdFragment : Fragment
    {
        ...
        public ThirdFragment(Activity maincontext)
        {
            context = maincontext;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            myListView = firstView.FindViewById<ListView>(Resource.Id.tslistview);

            ISharedPreferences preferences = PreferenceManager.GetDefaultSharedPreferences(context);
            usersList = dBHelper.GetRequests(preferences.GetInt("userId", 0));

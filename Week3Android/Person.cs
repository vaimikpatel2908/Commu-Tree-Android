...
namespace Week3Android
{
    public class Person
    {
        ...
        public List<Person> seedData()
        {
            ...
            usersList.Add(new Person() { username = "Milen Louis",    email = "milen@gmail.com",    age = 27, password = "milen", education = "Masters", address = "1399 Victoria Park Avenue", city = "Toronto", dob = "07/05/1996", maritalStatus = "Single", profession = "N/A" });
            ...
            usersList.Add(new Person() { username = "Kushal Sarawagi",email = "kushal@gmail.com",   age = 22, password = "kushal", education = "Graduate", address = "24 Parkway Forest Drive", city = "Toronto", dob = "04/03/1994", maritalStatus = "Single", profession = "N/A" });
            ...
            usersList.Add(new Person() { username = "Shreya Patel",   email = "shreya@gmail.com",   age = 23, password = "shreya", education = "Doctorate", address = "265 Danforth Avenue", city = "Toronto", dob = "05/30/1996", maritalStatus = "Marreied", profession = "N/A" });
